import HostingDeal from "../components/HostingDeal";
import RelatedHostingDeal from "../components/RelatedHostingDeal.jsx";

import { hostingDealsData } from "../assets/data.jsx";
import { relatedDealsData } from "../assets/data.jsx";
...
const Home = () => {
  return (
    <main>
      ...
      <div className="hosting-deal-container">
        {hostingDealsData.map((data, index) => (
          <HostingDeal data={data} index={index + 1} key={index} />
        ))}
      </div>
      <div>
        <h2>Related deals you might like for</h2>
        <div className="related-deal-container">
          {relatedDealsData.map((data, index) => (
            <RelatedHostingDeal data={data} key={index} />
          ))}
        </div>
      </div>
